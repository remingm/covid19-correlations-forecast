...
if __name__ == "__main__":
    st.info("Note: My main data source, covidtracking.com, has shut down their operation. The data here was last updated March 7, 2021. I will migrate to a new data source soon.")
